...
class Greeter {
  ...
  constructor(provider: ethers.providers.Web3Provider | ethers.providers.InfuraProvider, networkId: number = 4, signer?: Signer) {
  ...
  static async create(provider: ethers.providers.Web3Provider | ethers.providers.InfuraProvider, signer?: Signer): Promise<Greeter> {
